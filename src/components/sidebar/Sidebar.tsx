...
const menuItems: MenuItem[] = [
  ...
  },
  {
    label: "Customers",
    icon: customer,
    activeIcon: customerWhite,
    path: "/customers",
  },
  {
    label: "Categories",
    icon: category,
    activeIcon: categoryWhite,
    path: "/categories",
  },
  {
    label: "Earnings",
    icon: earnings,
    activeIcon: earningsWhite,
    path: "/earnings",
  },
  {
    label: "Transactions",
    ...
    <>
      ...
      <div
        className={`fixed top-0 left-0 h-full bg-white shadow-lg z-40 transition-all duration-300 overflow-y-auto
          ...
          md:translate-x-0 md:static md:block md:${
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      {!isCollapsed && (
                        <span
                          className={
                            isDropdownOpen ? "text-white" : "text-[#505050]"
                          }
                        >
                          {item.label}
                        </span>
              ...
              >
                {({ isActive }) => (
                  ...
                  >
                    ...
                    {!isCollapsed && (
                      <span
                        className={isActive ? "text-white" : "text-[#505050]"}
                      >
                        {item.label}
                      </span>
                    )}
